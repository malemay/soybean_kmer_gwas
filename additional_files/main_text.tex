...
\ref{pubescence_color_all_T_gene}).  Still, the fourth and fifth most strongly
associated \textit{k}-mers corresponded to the causal variant (Figures
\ref{pubescence_color_all_T_gene}, \ref{pubescence_color_all_T_kmers}). We
...
overall (Figures \ref{pubescence_color_all_T_signal},
\ref{pubescence_color_all_T_gene}). SV-based GWAS did not detect the causal variant
...
detected signals in this region using all three approaches, but only SNP-
and \textit{k}-mer-based GWAS identified a signal that overlapped Glyma.03g258700
...
for the SNP-based approach (Figures
...
with \emph{dt1} (Figure \ref{stem_termination_all_Dt1_kmers}). The existence of
