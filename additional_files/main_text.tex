...
discussed here are referred to Additional file 1. In particular, Table \ref{signals_table} (Additional file 1)
...
did not correspond to the causal variant (Additional file 1: Figure
\ref{pubescence_color_all_T_gene}d).  Still, the fourth and fifth most strongly
associated \textit{k}-mers corresponded to the causal variant (Additional file 1: Figures
...
using all three GWAS approaches (Additional file 1: Figures \ref{seed_coat_color_all_manhattan} and
...
approaches (Additional file 1: Figure \ref{seed_coat_color_greenyellow_manhattan}).
...
the SV discovery and genotyping steps can be found in Additional file 1.
...
lines. The phenotypic data used in this study can be found in Additional file 4.
