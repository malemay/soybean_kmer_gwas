...
%DIF ADD additional_files/manuscript.tex             Tue Jul  4 18:49:33 2023
...
\shortcite{rahman2018, he2021} which may solve issues like these and broaden the
...
demonstrated that 98.9\% of known translocations and
inversions as well as 99.6\% of known insertions/deletions in }\textit{\DIFadd{Arabidopsis thaliana}}
\DIFadd{could be tagged by unique 31-mers. It is therefore likely that the vast majority
of variants can be detected through the presence/absence of }\textit{\DIFadd{k}}\DIFadd{-mers.
}\DIFaddend 
