...
the main text. A summary of the signals found at all loci using all four
...
using all four methods (see main text and Figure
...
The first GWAS analysis on pubescence form found were signals on chromosomes Gm04 and Gm15 with Platypus
\emph{k}-merss (Figure \ref{pubescence_form_all_manhattan}). However,
