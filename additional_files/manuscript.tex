...
\begin{cfigure}
	...
	In the case of SNPs/indels, blue points denote markers used in the original analysis, whereas red points denote points that had originally been pruned but whose
