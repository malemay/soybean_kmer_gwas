...
# Using SVmerge for merging the svaba SVs used as input to Paragraph
...
# DEPENDENCY: variant_calling/svaba/svaba_filtered.vcf
SVmerge -ref ../../refgenome/Gmax_508_v4.0_mit_chlp.fasta \
	-variants svaba_filtered.vcf \
	-prefix svaba_svmerged \
	-maxdist 5 \
	-reldist 0.2 \
	-relsizediff 0.1 \
	-relshift 0.1 
